...
$all_trips = get_all_upcoming_trips_of_hajjee($_SESSION['user_id'], $pdo, $flag);
?>
<!doctype html>
<html lang="en">
...
<body>
    <?php if ($flag == 1) { ?>
        <h1 class="text-center">SHOWING ALL UPCOMING TRIP</h1>
    <?php } else { ?>
        <h1 class="text-center">TRIP ARCHIVE</h1>
    <?php } ?>
    <div class="container">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="card text-center" style="background-color:beige">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($flag == 1) { ?>
                                <form action="dbhandlers/trip_cancel_for_hajjee.php" method="post">
                                    <input hidden='true' name="hj_email" value="<?php echo $_SESSION['user_id']; ?>">
